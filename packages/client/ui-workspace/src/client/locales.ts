...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久销毁“{name}”的会话记录，且不可恢复。此操作会从归档中移除该会话。',
  'menu.fork': '分叉会话',
  'menu.archiveSession': '归档会话',
  'menu.unarchiveSession': '恢复归档',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently destroys the session log for “{name}”. It cannot be recovered, and the session is removed from the archive.',
