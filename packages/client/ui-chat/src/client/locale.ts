...
export const zh = {
  ...
  'stats.dialog.toolBreakdown': '工具用时明细',
  'stats.dialog.toolCalls.one': '{count} 次调用',
  'stats.dialog.toolCalls.other': '{count} 次调用',
...
export const en = {
  ...
  'stats.dialog.toolBreakdown': 'Tool time breakdown',
  'stats.dialog.toolCalls.one': '{count} call',
  'stats.dialog.toolCalls.other': '{count} calls',
