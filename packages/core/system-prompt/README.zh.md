...
| `includeOperatingGuidance` | `true` | 是否包含顺序为 −900 的 `harness:operating-guidance` 中由 harness 自有的执行纪律。仅当兼容性部署拥有逐字节固定的系统提示词时设为 false。 |
